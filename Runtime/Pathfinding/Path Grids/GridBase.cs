        ...
        private void GenerateGrid()
        {
            ...
            for(int x = 0; x < _gridSizeX; x++)
            {
                for(int y = 0; y < _gridSizeY; y++)
                {
                    ...
                    using NativeArray<PhysicsQuery.WorldOverlapResult> obstacles   = physicsWorld.OverlapShape(_shapeComponent.Shape,UnwalkableFilter);
                    
                    bool  traversable = !physicsWorld.TestOverlapPoint(worldPoint, UnwalkableFilter);
